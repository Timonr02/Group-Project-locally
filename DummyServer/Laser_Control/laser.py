...
class Laser:
    def __init__(
        ...
        self.actuator = None
        self.progress = 0
        self.last_job_duration_s = 0
        self.count_finished_card = 0
    ...
    def get_duration(self) -> float:
            return self.last_job_duration_s

    def get_count_card(self) -> float:
            return self.count_finished_card
    ...
    def _run_code(self, codes: list[str]):
        ...
        if self.is_running:
            return
        img = self.prev.generate_preview("\n".join(codes))
        img.save(self._gcode_dir + "img/tmp.png")
        ...
        self.last_job_duration_s = time() - self.run_start_time
        self.count_finished_card += 1
